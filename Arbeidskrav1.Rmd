...
Maksimalt oksygenopptak (V&#775;O~2max~) ble først beskrevet av Hill og Lupton i 1923, og kan defineres som kroppens evne til å ta opp og forbruke oksygen per tidsenhet [@HillLupton; @BassetHowley].
...
library(tidyverse)
library(readxl)
reliabilitet <- read_excel("realabilitet_uttrekning.xlsx") %>%
